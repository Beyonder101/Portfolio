...
interface CurtainLoaderProps {
  onButtonClick: () => void; // fires instantly on click — use for audio start
  onOpen: () => void;        // fires after curtain animation completes
}

export default function CurtainLoader({ onButtonClick, onOpen }: CurtainLoaderProps) {
  ...
  const handleOpen = () => {
    ...
    // Fire audio start IMMEDIATELY on click — this is the user gesture
    onButtonClick();

  ...
  return (
    ...
    >
      ...
      <button 
        ...
        className="px-8 py-3 rounded-2xl bg-white/10 backdrop-blur-md text-amber-50 font-serif tracking-widest text-lg hover:bg-white/20 transition-all shadow-[0_4px_30px_rgba(0,0,0,0.1)] border border-white/5"
      >
        INDEX
      </button>

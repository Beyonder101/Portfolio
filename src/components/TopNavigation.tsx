...
export default function TopNavigation({ visible }: TopNavigationProps) {
  ...
  return (
    <div 
      className={`absolute -top-28 left-0 w-full flex items-center justify-between z-[100] transition-all duration-1000 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6 pointer-events-none'}`}
    >
      ...
      <div className="flex gap-4">
        <a 
          ...
          className="w-24 h-14 rounded-2xl bg-white/5 backdrop-blur-sm flex items-center justify-center hover:bg-white/10 transition-all shadow-[0_4px_30px_rgba(0,0,0,0.1)] border border-white/5"
        >
